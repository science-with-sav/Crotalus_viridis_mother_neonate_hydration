...
```{r}
neonate_dab_osmol <- readRDS("data/neonate_DAB_osmolality.RDS")
...
```{r}
neonate_dab_all0 <- readRDS("data/neonate_DAB_body_size.RDS")
...
```{r}
neonate_postshed <- readRDS("data/neonate_PS_all_data.RDS")
```
...
```{r}
all_data_CEWL0 <- readRDS("data/CEWL_data_all.RDS")
