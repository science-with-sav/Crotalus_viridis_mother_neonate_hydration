...
summary(dab_clutch_mom$Mother_mass)
```
...
car::Anova(DAB_CEWL_LMM_0, test = "F", type = "2")
```
...
car::Anova(DAB_CEWL_LMM_5, test = "F", type = "2")
```
...
The full model is best, but it has double the variables of model 3, which is within the reasonable delta AIC range (2-3)...
...
car::Anova(DAB_CEWL_LMM_BEST_simple, test = "F", type = "2")
...
car::Anova(DAB_CEWL_LMM_BEST_full, test = "F", type = "2")
```
...
car::Anova(DAB_OSMOL_LMM_1b, test = "F", type = "2")
```
...
test_live <- lme4::lmer(data = dab_all,
                    Plasma_Osmol_Rep_mean ~ 
                      ...
                      live_neonates + 
                        (1|Mother_ID))
summary(test_live)
car::Anova(test_live, test = "F", type = "2")
...
test_total <- lme4::lmer(data = dab_all,
                    Plasma_Osmol_Rep_mean ~ 
                      ...
                      total_embryos + 
                        (1|Mother_ID))
summary(test_total)
car::Anova(test_total, test = "F", type = "2")
```
...
car::Anova(DAB_OSMOL_LMM_1c, test = "F", type = "2")
```
...
car::Anova(DAB_OSMOL_LMM_2, test = "F", type = "2")
```
...
car::Anova(DAB_OSMOL_LMM_3, test = "F", type = "2")
```
...
osml_models_all <- list(DAB_OSMOL_LMM_1c, DAB_OSMOL_LMM_2,
                        DAB_OSMOL_LMM_3, DAB_OSMOL_LMM_4,
                        DAB_OSMOL_LMM_5,
                        DAB_OSMOL_LMM_null)
...
```{r}
DAB_OSMOL_LMM_BEST2 <- lmerTest::lmer(data = dab_all,
                      Plasma_Osmol_Rep_mean ~ 
                      Treatment + 
                      Mother_osml +
                      live_neonates + 
                      Mass_g + 
                        (1|Mother_ID))
DAB_OSMOL_LMM_BEST_hmmm <- lmerTest::lmer(data = dab_all,
                      Plasma_Osmol_Rep_mean ~ 
                      Mother_osml +
                      live_neonates + 
                      Mass_g + 
                        (1|Mother_ID))
DAB_OSMOL_LMM_BEST3 <- lmerTest::lmer(data = dab_all,
                      Plasma_Osmol_Rep_mean ~ 
                      Treatment + 
                      Mother_osml +
                      Mass_g + 
                        (1|Mother_ID))
DAB_OSMOL_LMM_BEST4 <- lmerTest::lmer(data = dab_all,
                      Plasma_Osmol_Rep_mean ~ 
                      Treatment + 
                      Mother_osml +
                        (1|Mother_ID))
DAB_OSMOL_LMM_BEST5 <- lmerTest::lmer(data = dab_all,
                      Plasma_Osmol_Rep_mean ~ 
                      Treatment + 
                        (1|Mother_ID))

car::Anova(DAB_OSMOL_LMM_BEST2, test = "F", type = "2")
car::Anova(DAB_OSMOL_LMM_BEST_hmmm, test = "F", type = "2")
car::Anova(DAB_OSMOL_LMM_BEST3, test = "F", type = "2")
car::Anova(DAB_OSMOL_LMM_BEST4, test = "F", type = "2")
car::Anova(DAB_OSMOL_LMM_BEST5, test = "F", type = "2")
```
...
```{r}
summary(DAB_OSMOL_LMM_BEST5)

emmeans(DAB_OSMOL_LMM_BEST5, pairwise ~ Treatment)
DAB_OSMOL_emmeans <- emmeans(DAB_OSMOL_LMM_BEST5, "Treatment")
...
```{r}
ggsave(
  filename = "Fig3_neonate_mother_CEWL.pdf",
...
*NOTE* I did test the inclusion of Tb, msmt temp, and msmt VPD, and none had an influence on CEWL.
...
car::Anova(tb_lm_time_tmt, test = "F", type = "2")
```
...
summary(shedtimelm)
car::Anova(shedtimelm, test = "F", type = "2")
```
