...
car::Anova(DAB_OSMOL_LMM_3a, test = "F", type = "2")
```
...
car::Anova(DAB_OSMOL_tmt_LMM_4, test = "F", type = "2")
```
...
car::Anova(DAB_OSMOL_mom_LMM_2, test = "F", type = "2")
```
...
DAB_OSMOL_mom_LMM_4 <- lme4::lmer(data = dab_all,
                      ...
                      Mother_osml +
                        (1|Mother_ID))
car::Anova(DAB_OSMOL_mom_LMM_4, test = "F", type = "2")
```
...
car::Anova(DAB_OSMOL_LMM_BEST_tmt, test = "F", type = "2")
car::Anova(DAB_OSMOL_LMM_BEST_mom, test = "F", type = "2")
```
...
```{r}
ggsave(
  filename = "Fig6a_neonate_mother_osml.pdf",
  plot = neo_mom_osml,
  path = "./results_figures",
  device = "pdf",
  dpi = 600,
...
ggsave(
  filename = "Fig6b_neonate_mother_osml.pdf",
  plot = neo_tmt_osml,
  path = "./results_figures",
  device = "pdf",
  dpi = 600,
...
ggsave(
  filename = "Fig7_neonate_tmt_effects.pdf",
