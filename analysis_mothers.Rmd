...
```{r}
baseline_cewl_1a <- lme4::lmer(data = mothers_baseline,
                      CEWL_g_m2h ~
                        Tb_at_CEWL +
                        msmt_temp_C +
                        VPD_kPa +
...
drop1(baseline_cewl_1a)
anova(baseline_cewl_1a, test = "F", type = "2")
```
...
anova(baseline_cewl_5, test = "F", type = "2")
```
...
```{r}
emtrends(No_BirthSnakes_LMM_best, 
         "Hydration_Trmt", var = "Days_in_Treatment")
