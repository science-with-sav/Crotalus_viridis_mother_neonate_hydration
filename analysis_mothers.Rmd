...
I think this is redundant with the mother_data_all_final_2
```{r}
...
mother_data_all_final_2
```{r}
ggplot(data = mother_data_all_final_2, aes(x = msmt_temp_C, y = CEWL_g_m2h)) +
  geom_point(size = 2, 
             alpha = 0.7,
             color = "springgreen3") +
  annotate(geom = "text", 
...
ggplot(data = mother_data_all_final_2, aes(x = msmt_RH_percent, y = CEWL_g_m2h)) +
  geom_point(size = 2, 
             alpha = 0.7, 
             color = "springgreen3") +
  annotate(geom = "text", 
