...
filenames <- list.files(path = "CEWL data", pattern = "\\.csv$")
...
read_CEWL_file <- function(filename) {
  ...
  dat <- read.csv(file.path("CEWL data", filename), # load file
...
```{r save clean data}
saveRDS(CEWL_final, "./CEWL data/CEWL_data_all_clean.RDS")
```
